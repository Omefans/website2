                    ...
                    <div class="item-card-header">
                        ...
                        <div class="item-meta">
                            ...
                            <span class="item-likes" style="display: flex; align-items: center; gap: 6px;">
                                ...
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="#da3633" stroke="#da3633" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill-rule="evenodd" d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z M12 8l-2 3 3 2-2 3 3 2-2 0l0-10z"></path></svg> ${item.dislikes || 0}
                            </span>
                        </div>
