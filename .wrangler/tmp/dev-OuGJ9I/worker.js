...
// .wrangler/tmp/bundle-c3ipHb/checked-fetch.js
...
// .wrangler/tmp/bundle-c3ipHb/strip-cf-connecting-ip-header.js
...
app.post("/api/upload", async (c) => {
  try {
    ...
    await c.env.DB.prepare("INSERT INTO gallery_items (name, description, image_path, affiliate_url) VALUES (?, ?, ?, ?)").bind(name, description || "", imageUrl, affiliateUrl).run();
...
// .wrangler/tmp/bundle-c3ipHb/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c3ipHb/middleware-loader.entry.ts
